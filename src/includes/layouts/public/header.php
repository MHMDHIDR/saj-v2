        ...
        <?php else: ?>
          <div class="authLinks pull-right">
            ...
            <?php
              ...
              if($isAdmin == 2) { echo
                '<li><a href="control-panel/home?p=Main">Control Panel</a></li>';
              } elseif($isAdmin == 1) {
                /* isAdmin 1 means and Editor */
                require_once $controllersDir . 'articles/count-unapproved-articles.php';
              }
            ?>
            </ul>
          </div>
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <ul class="nav navbar-nav">
                <li class=<?php activeLink('submit-article') ?> ><a href="submit-article">Submit Article</a></li>
                <li class=<?php activeLink('terms') ?> ><a href="terms">Terms</a></li>
                <li class=<?php activeLink('editors') ?> ><a href="editors">Editors</a></li>
                <li class="dropdown">
                ...
                <li class=<?php activeLink('contact-us') ?> ><a href="contact-us">Contact</a></li>
              </ul>
            </div>
          </div>
        </nav>
